...
#include "../BService/struct/cmsgprintset.h"
...
struct qt_meta_stringdata_CMsgPrintSet_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMsgPrintSet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CMsgPrintSet_t qt_meta_stringdata_CMsgPrintSet = {
    {
QT_MOC_LITERAL(0, 0, 12) // "CMsgPrintSet"
...
QT_INIT_METAOBJECT const QMetaObject CMsgPrintSet::staticMetaObject = { {
    &CMsgStructBase::staticMetaObject,
    qt_meta_stringdata_CMsgPrintSet.data,
    qt_meta_data_CMsgPrintSet,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CMsgPrintSet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMsgPrintSet.stringdata0))
