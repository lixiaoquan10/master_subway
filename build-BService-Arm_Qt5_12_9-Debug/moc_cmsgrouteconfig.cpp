...
#include "../BService/struct/cmsgrouteconfig.h"
...
struct qt_meta_stringdata_CMsgRouteConfig_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMsgRouteConfig_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CMsgRouteConfig_t qt_meta_stringdata_CMsgRouteConfig = {
    {
QT_MOC_LITERAL(0, 0, 15) // "CMsgRouteConfig"
...
QT_INIT_METAOBJECT const QMetaObject CMsgRouteConfig::staticMetaObject = { {
    &CMsgStructBase::staticMetaObject,
    qt_meta_stringdata_CMsgRouteConfig.data,
    qt_meta_data_CMsgRouteConfig,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CMsgRouteConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMsgRouteConfig.stringdata0))
