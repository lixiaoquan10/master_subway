...
struct qt_meta_stringdata_CDistribution_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CDistribution_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CDistribution_t qt_meta_stringdata_CDistribution = {
    {
QT_MOC_LITERAL(0, 0, 13) // "CDistribution"
...
QT_INIT_METAOBJECT const QMetaObject CDistribution::staticMetaObject = { {
    &CObject::staticMetaObject,
    qt_meta_stringdata_CDistribution.data,
    qt_meta_data_CDistribution,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CDistribution::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CDistribution.stringdata0))
