...
struct qt_meta_stringdata_deviceForbidFault_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_deviceForbidFault_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_deviceForbidFault_t qt_meta_stringdata_deviceForbidFault = {
    {
QT_MOC_LITERAL(0, 0, 17) // "deviceForbidFault"
...
QT_INIT_METAOBJECT const QMetaObject deviceForbidFault::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_deviceForbidFault.data,
    qt_meta_data_deviceForbidFault,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *deviceForbidFault::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_deviceForbidFault.stringdata0))
