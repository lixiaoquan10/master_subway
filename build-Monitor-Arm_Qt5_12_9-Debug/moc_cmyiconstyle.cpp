...
struct qt_meta_stringdata_CMyIconStyle_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMyIconStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CMyIconStyle_t qt_meta_stringdata_CMyIconStyle = {
    {
QT_MOC_LITERAL(0, 0, 12) // "CMyIconStyle"
...
QT_INIT_METAOBJECT const QMetaObject CMyIconStyle::staticMetaObject = { {
    &QCommonStyle::staticMetaObject,
    qt_meta_stringdata_CMyIconStyle.data,
    qt_meta_data_CMyIconStyle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CMyIconStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMyIconStyle.stringdata0))
