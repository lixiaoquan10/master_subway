...
#include "../Monitor/struct/cmsgnull.h"
...
struct qt_meta_stringdata_CMsgNull_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMsgNull_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CMsgNull_t qt_meta_stringdata_CMsgNull = {
    {
QT_MOC_LITERAL(0, 0, 8) // "CMsgNull"
...
QT_INIT_METAOBJECT const QMetaObject CMsgNull::staticMetaObject = { {
    &CMsgStructBase::staticMetaObject,
    qt_meta_stringdata_CMsgNull.data,
    qt_meta_data_CMsgNull,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CMsgNull::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMsgNull.stringdata0))
