...
struct qt_meta_stringdata_CMsgCanportInfo_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CMsgCanportInfo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CMsgCanportInfo_t qt_meta_stringdata_CMsgCanportInfo = {
    {
QT_MOC_LITERAL(0, 0, 15) // "CMsgCanportInfo"
...
QT_INIT_METAOBJECT const QMetaObject CMsgCanportInfo::staticMetaObject = { {
    &CMsgStructBase::staticMetaObject,
    qt_meta_stringdata_CMsgCanportInfo.data,
    qt_meta_data_CMsgCanportInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CMsgCanportInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMsgCanportInfo.stringdata0))
